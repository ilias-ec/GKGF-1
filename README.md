...
<li> http://www.esa.int/Education/AstroPI/Meet_the_sense_hat_-_teach_with_space_T05.2
...
(min 18.3<sup>o</sup>C – max 26.6<sup>o</sup>C), relative humidity (min 50% - max 70%), pressure (min 979.0559 mbar –
max 1027.2769 mbar). 
...
formula u=sqrt(G*m/R), where: G=6,67428×10<sup>−11</sup> (Nm<sup>2</sup>/kg<sup>2</sup>) - Gravitational constant,
